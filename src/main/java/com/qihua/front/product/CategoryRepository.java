...
@Repository
public class CategoryRepository extends JdbcRepository<Category, Long> {
    ...
    public List<Category> selectCategory() {
        ...
        return jdbcTemplate.query(sql.toString(), new GenericBeanPropertyRowMapper<Category>(Category.class));
    }
    ...
    public Category selectCategory(Long categoryId) {
        ...
        return jdbcTemplate.queryForObject(sql.toString(), params, types, new GenericBeanPropertyRowMapper<Category>(
                Category.class));
    }
    ...
    public List<Category> selectSubcategoryByCatgeoryId(Long categoryId) {
        ...
        return jdbcTemplate.query(sql.toString(), params, types, new GenericBeanPropertyRowMapper<Category>(
                Category.class));
    }
