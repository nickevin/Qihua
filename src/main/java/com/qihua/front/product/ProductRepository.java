...
public class ProductRepository extends JdbcRepository<Product, String> {
  ...
  public PageModel<Product> selectByPagination(final ProductQueryParameter queryParam) {
    ...
    List<Product> result = jdbcTemplate.query(sql.toString(), params.toArray(),
        ...
        new GenericBeanPropertyRowMapper<Product>(Product.class));
  ...
  public List<Product> selectByScore(final int lowScore, final int highScore) {
    List<Object> params = new ArrayList<Object>();
    List<Integer> types = new ArrayList<Integer>();
  ...
  public List<ProductImg> selectProductImg(final String productId) {
    List<Object> params = new ArrayList<Object>();
    List<Integer> types = new ArrayList<Integer>();
  ...
  public List<ProductImg> selectFlashSaleImg(final String productId) {
    List<Object> params = new ArrayList<Object>();
    List<Integer> types = new ArrayList<Integer>();
  ...
  public ProductImg selectImgBlock(final String position) {
    List<Object> params = new ArrayList<Object>();
    List<Integer> types = new ArrayList<Integer>();
    ...
    return jdbcTemplate.queryForObject(sql.toString(), params.toArray(),
        ArrayUtils.toPrimitive(types.toArray(new Integer[types.size()])),
        new GenericBeanPropertyRowMapper<ProductImg>(ProductImg.class));
  }
