...
@Repository
public class MemberRepository extends JdbcRepository<Member, String> {
  ...
  public Member selectCredential(Member member) {
    ...
    return jdbcTemplate.queryForObject(sql.toString(),
        new Object[] {member.getMobile(), member.getMobile(), member.getPassword()},
        new int[] {Types.VARCHAR, Types.VARCHAR, Types.VARCHAR}, new GenericBeanPropertyRowMapper<Member>(Member.class));
  }
  ...
  public Member selectByMobile(String mobile) {
    ...
    return jdbcTemplate.queryForObject(sql, params, types, new GenericBeanPropertyRowMapper<Member>(Member.class));
  }
  ...
  public Member updatePassword(Member member) {
    ...
    Object[] params =
        new Object[] {member.getPassword(), new Timestamp(System.currentTimeMillis()), member.getMemberId()};
    int[] types = new int[] {Types.VARCHAR, Types.TIMESTAMP, Types.VARCHAR};

    jdbcTemplate.update(sql.toString(), params, types);

    return selectOne(member.getMemberId());
  }
  ...
  public Member updateScore(Member member) {
    ...
    Object[] params = new Object[] {member.getScore(), new Timestamp(System.currentTimeMillis()), member.getMemberId()};
